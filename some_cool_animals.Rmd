...
tabset creates different tabs! After this, if you create a fourth order heading, it will register that as the first tab...

#### Great white sharks

If you want to include the image even though it's in a diff folder use this syntax below...
...
Tabset section ended when you go back to three hashtags again
